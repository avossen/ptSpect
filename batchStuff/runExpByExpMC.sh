...
for d in `ls subMC_ex$ex\_$res\_$spec\_$stream/*.sh`; do bsub -q s $PWD/$d; done
    num_jobs=`bjobs | wc -l`
...
for pt in kT qT 
do
    mkdir mDstOut/subMC_ex$ex\_$res\_$spec\_$stream\_$pt/
    ./TwoHadAsymsCMod  ../groupData/ptSpect/subMC_ex$ex\_$res\_$spec\_$stream/ mDstOut/subMC_ex$ex\_$res\_$spec\_$stream\_$pt/ $pt
done
#delete large output
