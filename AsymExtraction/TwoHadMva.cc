...
int main(int argc, char** argv)
{
  ...
  memLocsF.push_back(&kaonPionRatio);
		  ...
		  for(int iPa2=PiPi;iPa2<=iPa1;iPa2++)
			...
			case mixedBinning:
			  {	
			    cout <<"-1-" <<endl;
			    vecBinning.push_back(binningM[iPa1].size());
			    for(int iZ=0;iZ<binningM[iPa1].size();iZ++)
			      {
				cout <<"iZ: " << iZ <<endl;
				stringstream str;
				str <<"z_from_";
				...
				for(int iM2=0;iM2<binningM[iPa1].size();iM2++)
				  {
				    ...
				    cout <<"myErr: " << mYErr[iM2] <<" myErr+Pr: " << mYErr_Pr[iM2] << " errFact: " << errFact <<endl;
#ifdef MC
				    cout <<"for mixed, numFalse: " << numFalseIdent[iBin][ind(iCh1,iCh2,NumCharge)][ind(iPa1,iPa2,NumParticle)][iZ][iM2] <<" numcorr: " <<numCorrIdent[iBin][ind(iCh1,iCh2,NumCharge)][ind(iPa1,iPa2,NumParticle)][iZ][iM2] <<endl;
