...
void doCompDrawHadRatioSame(char* filename, char* filenameWoA)
{
  ...
  TGraphErrors* tgBin1w_0=(TGraphErrors*)filew.Get("Normal_ptSpect_labT_z_ChargeInt__bin1_0");
  TGraphErrors* tgBin2w_0=(TGraphErrors*)filew.Get("Normal_ptSpect_labT_z_ChargeInt__bin2_0");
  TGraphErrors* tgBin3w_0=(TGraphErrors*)filew.Get("Normal_ptSpect_labT_z_ChargeInt__bin3_0");
  TGraphErrors* tgBin4w_0=(TGraphErrors*)filew.Get("Normal_ptSpect_labT_z_ChargeInt__bin4_0");
  ...
  TGraphErrors* tgBin1w_1=(TGraphErrors*)filew.Get("Normal_ptSpect_labT_z_ChargeInt__bin1_1");
  TGraphErrors* tgBin2w_1=(TGraphErrors*)filew.Get("Normal_ptSpect_labT_z_ChargeInt__bin2_1");
  TGraphErrors* tgBin3w_1=(TGraphErrors*)filew.Get("Normal_ptSpect_labT_z_ChargeInt__bin3_1");
  TGraphErrors* tgBin4w_1=(TGraphErrors*)filew.Get("Normal_ptSpect_labT_z_ChargeInt__bin4_1");
  ...
  TGraphErrors* tgBin1w_2=(TGraphErrors*)filew.Get("Normal_ptSpect_labT_z_ChargeInt__bin1_2");
  TGraphErrors* tgBin2w_2=(TGraphErrors*)filew.Get("Normal_ptSpect_labT_z_ChargeInt__bin2_2");
  TGraphErrors* tgBin3w_2=(TGraphErrors*)filew.Get("Normal_ptSpect_labT_z_ChargeInt__bin3_2");
  TGraphErrors* tgBin4w_2=(TGraphErrors*)filew.Get("Normal_ptSpect_labT_z_ChargeInt__bin4_2");
  ...
  TGraphErrors* ratio4_0=getRatioPlot(tgBin4_0,tgBin4w_0);
  TGraphErrors* ratio4_1=getRatioPlot(tgBin4_1,tgBin4w_1);
  TGraphErrors* ratio4_2=getRatioPlot(tgBin4_2,tgBin4w_2);
  ...
  ratio4_0->SetMarkerSize(2);
  ratio4_1->SetMarkerSize(2);
  ratio4_2->SetMarkerSize(2);

  ratio4_0->SetMarkerStyle(28);
  ratio4_1->SetMarkerStyle(28);
  ratio4_2->SetMarkerStyle(28);

  ratio4_0->SetMarkerColor(kMagenta);
  ratio4_1->SetMarkerColor(kMagenta);
  ratio4_2->SetMarkerColor(kMagenta);
