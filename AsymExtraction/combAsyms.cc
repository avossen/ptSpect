...
int main(int argc, char** argv)
{
...
#else
  chAs.Add("AsymmetriesRFilesForA/output_ex*.root");
#endif
  ...
  chAs.SetBranchAddress("meanThetaSin",&asymmetries::meanThetaSin);
  chAs.SetBranchAddress("meanThetaCos",&asymmetries::meanThetaCos);
  ...
  float***** meanTheta=allocateArray<float>(NumBin,(NumCharge*NumCharge+NumCharge)/2,(NumParticle*NumParticle+NumParticle)/2,maxKin,maxKin);
  float***** meanThetaSin=allocateArray<float>(NumBin,(NumCharge*NumCharge+NumCharge)/2,(NumParticle*NumParticle+NumParticle)/2,maxKin,maxKin);
  float***** meanThetaCos=allocateArray<float>(NumBin,(NumCharge*NumCharge+NumCharge)/2,(NumParticle*NumParticle+NumParticle)/2,maxKin,maxKin);
  ...
  for(long i=0;i<nevents;i++)
    {
      chAs.GetEntry(i);
      if(fabs(asymmetries::asymmetry) < 10e-8 || asymmetries::asError <10e-8)
	continue;
      ...
      //chi2Fit
      //ndfFit
      asyms[asymmetries::binning][ind(asymmetries::chargeType1,asymmetries::chargeType2,NumCharge)][ind(asymmetries::particleType1,asymmetries::particleType2,NumParticle)][asymmetries::kinBin1][asymmetries::kinBin2]+=asymmetries::asymmetry/(asymmetries::asError*asymmetries::asError);

      asymsWSum[asymmetries::binning][ind(asymmetries::chargeType1,asymmetries::chargeType2,NumCharge)][ind(asymmetries::particleType1,asymmetries::particleType2,NumParticle)][asymmetries::kinBin1][asymmetries::kinBin2]+=1/(asymmetries::asError*asymmetries::asError);

      meanKin1[asymmetries::binning][ind(asymmetries::chargeType1,asymmetries::chargeType2,NumCharge)][ind(asymmetries::particleType1,asymmetries::particleType2,NumParticle)][asymmetries::kinBin1][asymmetries::kinBin2]+=asymmetries::meanKinVal1/(asymmetries::asError*asymmetries::asError);
      meanKin2[asymmetries::binning][ind(asymmetries::chargeType1,asymmetries::chargeType2,NumCharge)][ind(asymmetries::particleType1,asymmetries::particleType2,NumParticle)][asymmetries::kinBin1][asymmetries::kinBin2]+=asymmetries::meanKinVal2/(asymmetries::asError*asymmetries::asError);
      meanTheta[asymmetries::binning][ind(asymmetries::chargeType1,asymmetries::chargeType2,NumCharge)][ind(asymmetries::particleType1,asymmetries::particleType2,NumParticle)][asymmetries::kinBin1][asymmetries::kinBin2]+=asymmetries::meanTheta/(asymmetries::asError*asymmetries::asError);
      meanThetaSin[asymmetries::binning][ind(asymmetries::chargeType1,asymmetries::chargeType2,NumCharge)][ind(asymmetries::particleType1,asymmetries::particleType2,NumParticle)][asymmetries::kinBin1][asymmetries::kinBin2]+=asymmetries::meanThetaSin/(asymmetries::asError*asymmetries::asError);
      meanThetaCos[asymmetries::binning][ind(asymmetries::chargeType1,asymmetries::chargeType2,NumCharge)][ind(asymmetries::particleType1,asymmetries::particleType2,NumParticle)][asymmetries::kinBin1][asymmetries::kinBin2]+=asymmetries::meanThetaCos/(asymmetries::asError*asymmetries::asError);
      ...
      if(asymmetries::chargeType1==PN && asymmetries::chargeType2==PN && asymmetries::particleType1==PiPi && asymmetries::particleType2==PiPi)
	{
	  	  ...
	  	  cout <<"got asymmetry: " << asymmetries::asymmetry<<endl;
	  if(fabs(asymmetries::asymmetry) > 10e-8 && asymmetries::asError > 10e-8)
	    asPiPiPN_Devs[asymmetries::binning][asymmetries::kinBin1][asymmetries::kinBin2]->Fill(asymmetries::asymmetry/(float)asymmetries::asError);
	  asPerExp[asymmetries::binning][asymmetries::kinBin1][asymmetries::kinBin2][expMap[asymmetries::expNr]][asymmetries::isOnRes]=asymmetries::asymmetry;
	  asErrorPerExp[asymmetries::binning][asymmetries::kinBin1][asymmetries::kinBin2][expMap[asymmetries::expNr]][asymmetries::isOnRes]=asymmetries::asError;
  ...
  for(int iBin=zBinning;iBin<=mixedBinning;iBin++)
			...
			case zBinning:
			  {
				...
				for(int iZ2=0;iZ2<binningZ[iPa1].size();iZ2++)
				  {
				    ...
				    asymFile << mY[iZ2] <<" +- " << mYErr[iZ2] <<endl;
			    ...
			    //			    sprintf(name,"GraphMacros/zC_ch1_%d_ch2_%d_pa1_%d_pa2_%d.pdf",iCh1,iCh2,iPa1,iPa2);
    ...
    asyms[iBin][ind(iCh1,iCh2,NumCharge)][ind(iPa1,iPa2,NumParticle)][iM][iM2]/=asymsWSum[iBin][ind(iCh1,iCh2,NumCharge)][ind(iPa1,iPa2,NumParticle)][iM][iM2];
		    ...
		    cout <<"M, kin2: " << meanKin2[iBin][ind(iCh1,iCh2,NumCharge)][ind(iPa1,iPa2,NumParticle)][iM][iM2] <<" div"  << asymsWSum[iBin][ind(iCh1,iCh2,NumCharge)][ind(iPa1,iPa2,NumParticle)][iM][iM2] <<endl;
				    ...
				    asymFile << mY[iM2] <<" +- " << mYErr[iM2] <<endl;
				  }
				...
				tg->SetName(name);
				tg->GetYaxis()->SetRangeUser(-0.3,0.3);
				sprintf(name2,"GraphMacros/%s.C",name);
				tg->Write();
				tg->SaveAs(name2);
				tg->SetMarkerStyle(6); 
			    ...
			    mC.SaveAs(name);
			    sprintf(name,"GraphMacros/mC_ch1_%d_ch2_%d_pa1_%d_pa2_%d.png",iCh1,iCh2,iPa1,iPa2);
			    mC.SaveAs(name);
			    break;
			  }
			case multBinning:
			  {
			    cout <<"mult binning not yet implemented" << endl;
			    break;
			  }
			case mixedBinning:
			  {
			    //stuff for aurore
			    asymFile <<" mixedBinning " << endl;
			    TCanvas mC;
			    mC.Divide(3,2);
				...
				for(int iZ=0;iZ<binningZ[iPa1].size();iZ++)
				  {
				    meanTheta[iBin][ind(iCh1,iCh2,NumCharge)][ind(iPa1,iPa2,NumParticle)][iZ][iM2]/=asymsWSum[iBin][ind(iCh1,iCh2,NumCharge)][ind(iPa1,iPa2,NumParticle)][iZ][iM2];
				    meanThetaSin[iBin][ind(iCh1,iCh2,NumCharge)][ind(iPa1,iPa2,NumParticle)][iZ][iM2]/=asymsWSum[iBin][ind(iCh1,iCh2,NumCharge)][ind(iPa1,iPa2,NumParticle)][iZ][iM2];
				    meanThetaCos[iBin][ind(iCh1,iCh2,NumCharge)][ind(iPa1,iPa2,NumParticle)][iZ][iM2]/=asymsWSum[iBin][ind(iCh1,iCh2,NumCharge)][ind(iPa1,iPa2,NumParticle)][iZ][iM2];
				    cout << "iz: " << iZ <<" im: " << iM2 <<endl;
				    cout <<"meanTheta: " << meanTheta[iBin][ind(iCh1,iCh2,NumCharge)][ind(iPa1,iPa2,NumParticle)][iZ][iM2]<<endl;
				    cout <<"meanThetaSin: " << meanThetaSin[iBin][ind(iCh1,iCh2,NumCharge)][ind(iPa1,iPa2,NumParticle)][iZ][iM2]<<endl;
				    cout <<"meanThetaCos: " << meanThetaCos[iBin][ind(iCh1,iCh2,NumCharge)][ind(iPa1,iPa2,NumParticle)][iZ][iM2]<<endl;
				    cout <<"ratio: " << meanThetaSin[iBin][ind(iCh1,iCh2,NumCharge)][ind(iPa1,iPa2,NumParticle)][iZ][iM2]/ meanThetaCos[iBin][ind(iCh1,iCh2,NumCharge)][ind(iPa1,iPa2,NumParticle)][iZ][iM2]<<endl;
				  }
